...
const adminStatements: RoleStatements = {
  ...
  attribution: ['read', 'list'],
  contrat: ['read', 'list'],
  conge: ['read', 'list', 'validate', 'reject'],
  absence: ['read', 'list', 'validate', 'reject'],
  workflow: ['read', 'list'],
  site: ['read', 'list'],
  poste: ['read', 'list'],
  fonction: ['read', 'list'],
...
const rhStatements: RoleStatements = {
  ...
  conge: ['create', 'read', 'update', 'delete', 'list', 'transmit', 'cancel_waiting'],
  absence: ['create', 'read', 'update', 'delete', 'list', 'transmit', 'cancel_waiting'],
  ...
  reporting:['create', 'read', 'update', 'delete', 'list'],
}

const csaStatements: RoleStatements = {
  employe: ['read', 'list'],
  bulletin: ['read', 'list', 'validate'],
  lot: ['read', 'list', 'calculate', 'publish', 'waiting', 'cancel_waiting'],
  rubrique: ['read', 'list'],
  session: ['read', 'list'],
  document: ['read', 'list'],
  nomination: ['read', 'list'],
