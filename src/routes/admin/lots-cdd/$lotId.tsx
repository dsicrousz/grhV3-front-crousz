...
export const Route = createFileRoute('/admin/lots-cdd/$lotId')({
  component: LotCddDetailsPage,
})

function LotCddDetailsPage() {
      ...
      <div className="p-6">
        <Space>
          <Button 
            ...
            onClick={() => navigate({ to: '/admin/lots-cdd' })}
          >
            Retour
          </Button>
          <Text type="danger">Lot CDD non trouvé</Text>
        </Space>
      </div>
    )
  }
